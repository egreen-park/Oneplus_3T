...
class LatControlTorque(LatControl):
  ...
  def update(self, active, CS, VM, params, last_actuators, steer_limited, desired_curvature, desired_curvature_rate, llk):
    ...
    if CS.vEgo < MIN_STEER_SPEED or not active:
      ...
      #low_speed_factor = interp(CS.vEgo, [15, 20, 30], [300,300, 0]) # 10=22mile(36km) 15=34mile (54km) 20=45mile(72km), 30=67mile(108), 40=90mile(144)
      ...
      print('error', error, 'vEgo', CS.vEgo, 'low_factor', low_speed_factor, 'compensation', friction_compensation, 'desired_lateral_accel', desired_lateral_accel)
